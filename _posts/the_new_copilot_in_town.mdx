...
description: A blog about the new GitHub Co-Pilot. Github announced their new tool Github Co-Pilot, on June 29, 2021. This will be a blog version of our recent episode about Github Co-Pilot.
---
...
our Github Co-pilot episode <Link href="/podcast/github-co-pilot-stealing-jobs-or-an-honest-pair-programmer"> here </Link>
. At the time of writing this blog Github Co-Pilot is still in the technical preiew stage, which means only those who are given permision are able to use it. You can sign up for the service using this [link](https://github.com/features/copilot/signup){target="_blank"}.
...
![github co-pilot in action](/assets/copilot-in-action.png){target="_blank"}
...
Github Co-Pilot is mainly built by a team of engineers at Github and [Open AI](https://openai.com/){target="_blank"}. The A.I part of Github Co-Pilot is powered by the new language processing model from Open AI, Codex.
...
- For some reason Gihub Co-Pilot sometimes get into a loop of suggestions, it even did the same thing while I was writing this blog post.
  ...
  ![Co-pilot loop suggestion](/assets/copilot-suggest-loop.jpeg)
...
- There were also occassions where Github Co-Pilpt suggested unclear things like Stackoverflow URLs that were probably left in people's code as a comment.
  ...
  ![Co-pilot bad suggestion](/assets/copilot-bad-suggestion.jpeg)
