...
const StoryCard: FC<storyProps> = ({ title, description, color }) => (
  <div className="bg-white dark:bg-gray-900 p-4 text-left transition-all duration-100 hover:shadow-xl text-black rounded-lg">
    <div
      className={`text-3xl ${color} border-b dark:border-gray-800 border-gray-50 pb-3 mb-4 text-left font-bold`}
    >
      {title}
